...
<table class="mdl-data-table mdl-js-data-table  mdl-shadow--2dp">
  ...
  <tbody>
    ...
    <tr>
	    ...
	    <td>
		    ...
		    <div class="imglist__item">
		    	<img class="imglist__image" src="<? echo $user_data[0]['attach']->logo; ?>" height="45" /><a onclick="deleteLogo(<?echo $user_data[0]['id'];?>)" class="mdl-button mdl-js-button delbtn mdl-button--fab mdl-js-ripple-effect"><i class="material-icons">clear</i></a>
		    </div>
		    <?}?>
    ...
    <tr>
	    ...
	    <td>
	    	<textarea id="aboutText1" name="aboutText"><? if($user_data[0]['attach']!='') echo $user_data[0]['attach']->about; ?></textarea>
		    <script>
